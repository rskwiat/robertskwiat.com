    ...
    return (
      <section id="about" className="container">
        <div>
          ...
          <Paragraph copy="I currently claim residence in New York and available for freelance work." />
