export default function(){
  return [
    { paragraph: 'As a front end developer, I\'ve been lucky enough to work with a few excellent companies including Small Earth Group, Ten Twenty Five, Spies & Assassins and Mediabrix. I have a dual background in Design and Advertising, so I understand the visual mechanics as well as the coding that brings web applications together.', id: "bio"},
    ...
    { paragraph: 'I currently claim residence in Manhattan, NY and is available for freelance work.', id: "freelance" },
  ]
}
